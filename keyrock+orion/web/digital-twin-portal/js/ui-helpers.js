...
import {
    userDropdown, usersTab, rolesTab, auditTab, settingsTab, orionTab, digitalTwinTab, 
    usersSection, rolesSection, auditSection, settingsSection, orionSection, digitalTwinSection
...
export function clearTabButtonStyles() {
    [usersTab, rolesTab, auditTab, settingsTab, orionTab, digitalTwinTab].forEach((btn) => {
